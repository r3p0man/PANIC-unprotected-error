...
return function (connection, req, args)
  ...
  sendAttr(connection, "Waty m-1"               , tostring(a[1]*40))
  sendAttr(connection, "Waty m-2"               , tostring(a[2]*40))
  sendAttr(connection, "Waty m-3"               , tostring(a[3]*40))
  sendAttr(connection, "Waty m-4"               , tostring(a[4]*40))
  sendAttr(connection, "Waty m-5"               , tostring(a[5]*40))
